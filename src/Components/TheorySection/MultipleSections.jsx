...
export const TheoryExamScreen = () => {
  ...
  const timeStr = questionPaperData.exam_details?.time_allowed || "0";
  let mins = 0;
...
const handleSubmit = () => {
  navigate("/review-answers", { state: { answers, questionPaperData } });
};
...
const formatTime = (secs) => {
  ...
  // API configuration
  const API_BASE_URL = "https://test-medhvrushti.checkerslab.com/api/v1/cil/assessment/fetch/theory";
